classdef CsvFileAdapter < datatree.adapter.ContentAdapter
    ...
    methods
        function obj = CsvFileAdapter(filePath)
            % Constructor
        ...
        function open(obj, filePath)
            ...
            try
                ...
                obj.FileData = table2struct(M);
            catch ME
                error('CsvFileAdapter:LoadError', 'Error loading CSV file: %s', ME.message);
            end
        end
